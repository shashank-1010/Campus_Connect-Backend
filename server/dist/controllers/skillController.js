...
exports.getCategories = exports.getUserSkills = exports.deleteSkill = exports.updateSkill = exports.getSkillById = exports.getSkills = exports.createSkill = void 0;
...
const getSkills = async (req, res) => {
    try {
        ...
        let query = {}; // Remove default availability filter
        // Apply filters
        ...
        const skills = await Skill_1.default.find(query)
            .sort({ createdAt: -1 })
            .limit(50);
        res.json({
            success: true,
...
const getUserSkills = async (req, res) => {
    try {
        const skills = await Skill_1.default.find({ 'userId._id': req.userId })
            .sort({ createdAt: -1 });
        res.json({
            success: true,
            skills
